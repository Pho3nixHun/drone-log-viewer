              ...
              <Tooltip
                label={
                  <Stack gap={4}>
                    ...
                    <Text size="xs">
                      Method: {layer.parameters.distributionMethod}
                    </Text>
                    <Text size="xs">Sigma: {layer.parameters.sigma}m</Text>
                    <Text size="xs">
                      Max Distance: {layer.parameters.maxDistance}m
                    </Text>
                    <Text size="xs">
                      Insects/Drop: {layer.parameters.insectsPerDrop}
                    </Text>
                    {layer.parameters.levyAlpha && (
                      <Text size="xs">Alpha: {layer.parameters.levyAlpha}</Text>
                    )}
                    {layer.parameters.exponentialLambda && (
                      <Text size="xs">
                        Lambda: {layer.parameters.exponentialLambda}
                      </Text>
                    )}
                    <Text size="xs" c="dimmed">
                      Created: {layer.createdAt.toLocaleTimeString()}
                    </Text>
                  </Stack>
                }
                multiline
        ...
        {currentMission.missionSettings &&
          ...
          selectedLayers.has("polygonUnion") && (
            <Group gap="xs">
              ...
              />
              <Text size="xs" c="dimmed">
                Total coverage area (overlaps merged)
              </Text>
            </Group>
          )}
      </Stack>
