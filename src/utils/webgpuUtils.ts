...
export function isWebGPUSupported(): boolean {
  return (
    "gpu" in navigator && typeof navigator.gpu.requestAdapter === "function"
  );
}
 ...
 * @param existingAdapter Optional existing adapter to use instead of requesting a new one
 */
export async function initializeWebGPU(
  existingAdapter?: GPUAdapter | null,
...
export function createHeatmapBuffers(
  ...
  paramsView.setUint32(offset, parameters.canvasWidth, true);
  offset += 4;
  paramsView.setUint32(offset, parameters.canvasHeight, true);
  offset += 4;
  paramsView.setFloat32(offset, parameters.sigma, true);
  offset += 4;
  paramsView.setFloat32(offset, parameters.maxDistance, true);
  offset += 4;
  paramsView.setFloat32(offset, parameters.insectsPerDrop, true);
  offset += 4;
  paramsView.setFloat32(offset, parameters.pixelsPerMeter, true);
  offset += 4;
  paramsView.setUint32(offset, parameters.dropPointCount, true);
  offset += 4;
  paramsView.setFloat32(offset, parameters.boundedMinLat, true);
  offset += 4;
  paramsView.setFloat32(offset, parameters.boundedMaxLat, true);
  offset += 4;
  paramsView.setFloat32(offset, parameters.boundedMinLng, true);
  offset += 4;
  paramsView.setFloat32(offset, parameters.boundedMaxLng, true);
  offset += 4;
  paramsView.setFloat32(offset, parameters.boundedLatRange, true);
  offset += 4;
  paramsView.setFloat32(offset, parameters.boundedLngRange, true);
  offset += 4;
  paramsView.setUint32(offset, parameters.distributionMethod, true);
  offset += 4;
  paramsView.setFloat32(offset, parameters.levyAlpha, true);
  offset += 4;
